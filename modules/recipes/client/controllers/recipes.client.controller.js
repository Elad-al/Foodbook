(function () {
  ...
  RecipesController.$inject = ['$scope', '$state', '$window', 'Authentication', 'Socket','recipeResolve'];

  function RecipesController($scope, $state, $window, Authentication, Socket, recipe) {
    var vm = this;
    ...
    Socket.on('recips.created', function (article) {
        //console.log(article);
    });
